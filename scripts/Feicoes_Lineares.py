...
class FeiesLineares(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterVectorLayer('Aval', 'Adicione a camada a ser avaliada:', types=[QgsProcessing.TypeVectorLine], defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            'INPUT': parameters['Aval'],
            'INPUT_FIELDS': [''],
            'INTERSECT': parameters['Aval'],
            'INTERSECT_FIELDS': ['0'],
...
<p>Este algoritimo identifica o cruzamento em feições lineares e realiza a comparação de uma base de referência a uma base para avaliação. Esta comparação resulta numa camada pontual apresentando os pontos de cruzamento da camada avaliada considerados homólogos à camada de referência.
...
<p>Selecionar o shapefile para identificação de pontos homólogos à base de referência.</p>
<h3>Cruzamentos Homólogos</h3>
<p>Camada vetorial dos pontos de cruzamento considerados homólogos aos cruzamentos de referência.</p>
<h2>Saídas</h2>
<h3>Cruzamentos Homólogos</h3>
<p>Camada vetorial dos pontos de cruzamento considerados homólogos aos cruzamentos de referência.</p>
